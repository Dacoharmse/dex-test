...
<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" style="width:100%;max-width:100%;">
    <tr>
        <td align="center" bgcolor="#111827" data-composer>
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                <tr>
                    <td align="center" bgcolor="#111827" class="container-padding">
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr>
                                <td align="center" class="center-text">
                                    <a href="{{ url('/') }}"><img style="width:300px;border:0px;display: inline!important;" src="{{ asset('images/white_logo.png') }}" width="300" border="0" alt="{{ config('app.name') }}"></a>
                                </td>
                            </tr>
                            <tr>
                                <td height="40" style="font-size:40px;line-height:40px;">&nbsp;</td>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                <tr>
                    <td align="center" bgcolor="#FFFFFF">
                        <img style="width:50px;border:0px;display: inline!important;" src="{{ asset('images/Arrow.png') }}" width="50" border="0" alt="arrow">
                    </td>
                </tr>
            </table>
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr>
                                <td align="center">
                                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="row" width="480" style="width:480px;max-width:480px;">
                                        <tr>
                                            <td align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                @yield('content')
                                            </td>
                                        </tr>
                                    </table>
                ...
                <tr>
                    <td align="center" bgcolor="#f0f0f0" class="container-padding">
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                                        ...
                                                        <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="https://t.me/dex_tokens"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('images/telegram.webp') }}" width="36" border="0" alt="icon"></a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                            </table>
                            ...
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    <a href="mailto:support@dex-tokens.com" style="color:#6e6e6e;"><span>support@dex-tokens.com</span></a> - <a href="{{ url('/') }}" style="color:#6e6e6e;"><span>{{ url('/') }}</span></a>
                                </td>
                            </tr>
                            <tr>
                                <td height="30" style="font-size:30px;line-height:30px;">&nbsp;</td>
